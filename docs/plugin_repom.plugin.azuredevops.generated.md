...
- [`azure-devops-create-pr@2`](#azure-devops-create-pr2)
...
<!-- snippet: azure-devops-create-pr@2-scenario01 -->
<a id='snippet-azure-devops-create-pr@2-scenario01'></a>
```yaml
- type: azure-devops-create-pr@2
  project-id: "{{ project_id }}"
  name: Create feature to develop ({{ repository.branch | string.replace "feature/" "" | string.strip | string.truncate 20 ".." }})
  pr-title: 'Release {{ now }}'
  to-branch: develop
  ...
  active: 'repository.branch | string.starts_with "feature/"'
```
<sup><a href='/tests/RepoM.Plugin.AzureDevOps.Tests/ActionMenu/IntegrationTests/AzureDevopsCreatePrV2Tests.CreatePullRequestScenario01.testfile.yaml#L10-L29' title='Snippet source file'>snippet source</a> | <a href='#snippet-azure-devops-create-pr@2-scenario01' title='Start of snippet'>anchor</a></sup>
<!-- endSnippet -->

<!-- snippet: azure-devops-create-pr@2-scenario02 -->
<a id='snippet-azure-devops-create-pr@2-scenario02'></a>
```yaml
- type: azure-devops-create-pr@2
  project-id: "{{ project_id }}"
  name: Complete feature
  ...
  active: true
```
<sup><a href='/tests/RepoM.Plugin.AzureDevOps.Tests/ActionMenu/IntegrationTests/AzureDevopsCreatePrV2Tests.CreatePullRequestScenario01.testfile.yaml#L31-L43' title='Snippet source file'>snippet source</a> | <a href='#snippet-azure-devops-create-pr@2-scenario02' title='Start of snippet'>anchor</a></sup>
<!-- endSnippet -->

<!-- snippet: azure-devops-create-pr@2-scenario03 -->
<a id='snippet-azure-devops-create-pr@2-scenario03'></a>
```yaml
- type: azure-devops-create-pr@2
  project-id: "{{ project_id }}"
  to-branch: develop
```
<sup><a href='/tests/RepoM.Plugin.AzureDevOps.Tests/ActionMenu/IntegrationTests/AzureDevopsCreatePrV2Tests.CreatePullRequestScenario01.testfile.yaml#L45-L51' title='Snippet source file'>snippet source</a> | <a href='#snippet-azure-devops-create-pr@2-scenario03' title='Start of snippet'>anchor</a></sup>
<!-- endSnippet -->
