...
internal partial class RepositoryFunctions : ScribanModuleWithFunctions
{
    ...
    [ActionMenuMember("name", "repo-cat")]
    ...
    [ActionMenuMember("path", "repo-cat")]
    ...
    [ActionMenuMember("branch", "repo-cat")]
    ...
    /// </summary>
    /// <returns>The name of the current branch.</returns>
    [ActionMenuMember("branches", "repo-cat")]
    ...
    [ActionMenuMember("local-branches", "repo-cat")]
