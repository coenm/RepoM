...
{
    protected override async IAsyncEnumerable<UserInterfaceRepositoryAction> MapAsync(RepositoryActionCommandV1 action, IActionMenuGenerationContext context, IRepository repository)
    {
