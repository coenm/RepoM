...
public class ActionGitFetchV1Mapper : IActionToRepositoryActionMapper
{
    ...
    public ActionGitFetchV1Mapper(RepositoryExpressionEvaluator expressionEvaluator, ITranslationService translationService, IRepositoryWriter repositoryWriter)
    {
