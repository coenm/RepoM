...
partial class CommandLineOptions
{
    ...
    public static string GetUsage()
    {
        ...
        help.AddPostOptionsLine("⁞   like \"RepoM\" or \"NSidekick\", for example)");
        help.AddPostOptionsLine("");

        help.AddPostOptionsLine("Basics:");
        help.AddPostOptionsLine("⁞  grr \t\t\tLists all repositories found in RepoM including their status");
        ...
        help.AddPostOptionsLine("⁞  grr \"n Repo\"\t\tThe prefix \"n \" forces RepoM to filter for repository names (optional)");
        help.AddPostOptionsLine("⁞  grr \"b master\"\tThe prefix \"b \" forces RepoM to filter for repository branches");
        help.AddPostOptionsLine("⁞  grr \"p C:\\\"\t\tThe prefix \"p \" forces RepoM to filter for repository paths");
        help.AddPostOptionsLine("");
        ...
        help.AddPostOptionsLine("⁞  RepoM has to be running on this system to use grr.");
        help.AddPostOptionsLine("");
