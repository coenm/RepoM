...
public class ActionGitFetchV1Mapper : IActionToRepositoryActionMapper
{
    ...
    public ActionGitFetchV1Mapper(IRepositoryExpressionEvaluator expressionEvaluator, ITranslationService translationService, IRepositoryWriter repositoryWriter)
    {
