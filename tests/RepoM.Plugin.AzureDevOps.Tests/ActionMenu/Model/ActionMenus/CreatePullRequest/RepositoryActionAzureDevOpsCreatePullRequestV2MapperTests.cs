...
public class RepositoryActionAzureDevOpsCreatePullRequestV2MapperTests
{
    private readonly RepositoryActionAzureDevOpsCreatePullRequestV2Mapper _sut = new (NullLogger.Instance);
    private readonly RepositoryActionAzureDevOpsCreatePullRequestV2 _action;
    private readonly IActionMenuGenerationContext _context;
    private readonly IRepository _repository;

    public RepositoryActionAzureDevOpsCreatePullRequestV2MapperTests()
    {
        _action = new RepositoryActionAzureDevOpsCreatePullRequestV2();
    ...
    [Fact]
    public async Task Map_ShouldReturnResult_WhenRepositoryHasLocalChanges()
    {
        // arrange
