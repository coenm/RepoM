...
internal class RepositoryComparerSettingMarkdownVisitor : Visitor
{
    private readonly Dictionary<string, string> _builtinClassNames;
    private StringWriter _writer;
    private StringWriter _writerSummary;

    public RepositoryComparerSettingMarkdownVisitor(Dictionary<string, string> builtinClassNames)
    {
