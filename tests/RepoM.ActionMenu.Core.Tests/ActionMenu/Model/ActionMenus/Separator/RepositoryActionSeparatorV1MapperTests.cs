namespace RepoM.ActionMenu.Core.Tests.ActionMenu.Model.ActionMenus.Separator;
...
[UsesVerify]
public class RepositoryActionSeparatorV1MapperTests
{
    private readonly RepositoryActionSeparatorV1Mapper _sut = new ();
    private readonly RepositoryActionSeparatorV1 _action;
    private readonly IActionMenuGenerationContext _context;
    private readonly IRepository _repository;
    private readonly VerifySettings _verifySettings = new();

    public RepositoryActionSeparatorV1MapperTests()
    {
        _action = new RepositoryActionSeparatorV1();
