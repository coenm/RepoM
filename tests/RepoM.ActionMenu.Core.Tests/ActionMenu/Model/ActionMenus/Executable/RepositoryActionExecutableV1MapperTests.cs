namespace RepoM.ActionMenu.Core.Tests.ActionMenu.Model.ActionMenus.Executable;
...
[UsesVerify]
public class RepositoryActionExecutableV1MapperTests
{
    private readonly RepositoryActionExecutableV1Mapper _sut = new ();
    private readonly RepositoryActionExecutableV1 _action;
    private readonly IActionMenuGenerationContext _context;
    private readonly IRepository _repository;
    private readonly VerifySettings _verifySettings = new();

    public RepositoryActionExecutableV1MapperTests()
    {
        _action = new RepositoryActionExecutableV1
        {
                Name = "dummy-name",
                Executable = "abc.exe",
                Arguments = "a b x",
