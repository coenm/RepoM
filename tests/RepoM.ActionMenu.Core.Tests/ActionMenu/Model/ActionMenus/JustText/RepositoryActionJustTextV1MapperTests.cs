namespace RepoM.ActionMenu.Core.Tests.ActionMenu.Model.ActionMenus.JustText;
...
public class RepositoryActionJustTextV1MapperTests
{
    ...
    private readonly RepositoryActionJustTextV1 _action;
    private readonly IActionMenuGenerationContext _context;
    private readonly IRepository _repository;
    private readonly VerifySettings _verifySettings = new();

    public RepositoryActionJustTextV1MapperTests()
    {
        _action = new RepositoryActionJustTextV1
            {
                Name = "dummy-name",
            };
