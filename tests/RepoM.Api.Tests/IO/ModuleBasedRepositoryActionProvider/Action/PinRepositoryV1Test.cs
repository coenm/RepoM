...
public class PinRepositoryV1Test
{
    ...
    [Fact]
    public async Task Deserialize_PinV1()
    {
        // arrange
    ...
    {
        // arrange
        _testFileSettings.UseMethodName(nameof(Deserialize_PinV1));
        var content = await EasyTestFile.LoadAsText(_testFileSettings);
        ...
        // assert
        _ = result.ActionsCollection.Actions.Should().AllBeOfType<RepositoryActionPinRepositoryV1>();
    }
}